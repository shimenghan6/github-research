...
set "DIR=%USERPROFILE%\.claude\skills\github-research"
...
if exist "%~dp0SKILL.md" (
    ...
    :: From GitHub (online)
    set "URL=https://raw.githubusercontent.com/shimenghan6/github-research/master/SKILL.md"
    echo   正在从 GitHub 下载...
